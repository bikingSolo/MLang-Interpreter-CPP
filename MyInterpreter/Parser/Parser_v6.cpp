// теперь оператор присваивания это оператор выражение, а выражение включает в себя операцию присваивания
...
class Parser {
    ...
    Scanner      scan;
    bool flag;
    stack < int >           st_int;   // стек для контроля описаний
    stack < int >           st_init;  // стек для инициализации ( собираем имена, которые надо проинициализировать )
